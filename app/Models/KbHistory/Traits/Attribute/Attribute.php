<?php namespace App\Models\KbHistory\Traits\Attribute;
...
use App\Repositories\KbHistory\EloquentKbHistoryRepository;
...
trait Attribute
{
    ...
    {
        $repository = new EloquentKbHistoryRepository;
